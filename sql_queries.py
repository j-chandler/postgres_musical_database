...
user_table_create = ("""
    CREATE TABLE IF NOT EXISTS users (user_id int PRIMARY KEY, first_name varchar, last_name varchar, gender char(1), level varchar)
""")
...
song_select = ("""
    ...
    AND artists.name = %s
    WHERE songs.title = %s AND duration = %s
""")
